...
class BackgroundDecorations:
    ...
    def __init__(self, decoration_paths: List[str], scroll_speed: float, screen_width: int, 
        ...
        if self.decoration_images:
            ...
            decoration_count = max(5, int((screen_width * 2) / DECORATION_MIN_HORIZONTAL_SPACING) + 2)
    ...
    def _create_random_decorations(self, count: int) -> None:
        ...
        for i in range(count):
            ...
            if i == on_screen_count and current_x < self.screen_width:
                ...
                current_x = max(current_x + DECORATION_MIN_HORIZONTAL_SPACING, 
    ...
    def update(self) -> None:
        ...
        for decoration in self.decorations:
            ...
            if decoration["pos"][0] < -decoration["width"]:
                ...
                new_x = max(rightmost_x + DECORATION_MIN_HORIZONTAL_SPACING + random.randint(0, 200), 
                           self.screen_width + 100)
                ...
                section_bottom = min(section_top + section_height, bottom_limit - decoration["height"])
